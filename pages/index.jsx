...
export default class App extends React.Component{
  constructor(props){
    ...
    this.state={
      dataset:{},
      temp0: 0, weather0:'',clouds0:0, snow0:0, rain0:0, weatherIcon0:'', cmaxtem0:0, cmintem0:0,
      temp1: 0, weather1:'',clouds1:0, snow1:0, rain1:0, weatherIcon1:'', cmaxtem1:0, cmintem1:0,
      temp2: 0, weather2:'',clouds2:0, snow2:0, rain2:0, weatherIcon2:'', cmaxtem2:0, cmintem2:0,
      temp3: 0, weather3:'',clouds3:0, snow3:0, rain3:0, weatherIcon3:'', cmaxtem3:0, cmintem3:0,
      temp4: 0, weather4:'',clouds4:0, snow4:0, rain4:0, weatherIcon4:'', cmaxtem4:0, cmintem4:0,
      temp5: 0, weather5:'',clouds5:0, snow5:0, rain5:0, weatherIcon5:'', cmaxtem5:0, cmintem5:0,
      temp6: 0, weather6:'',clouds6:0, snow6:0, rain6:0, weatherIcon6:'', cmaxtem6:0, cmintem6:0,
      loading:false,
      lat:35.6518205,
      lon:139.5446124,
  ...
  componentDidMount(){
    (async()=>{
      const APIURL ='https://api.openweathermap.org/data/2.5/onecall?lat='+this.state.lat+'&lon='+this.state.lon+'&units=metric&appid=f9794935a670f65e810fe0253ce78aa8';
  ...
  TodayWeather = () => {
    ...
    this.setState({rain0:'降水確率:'+this.state.dataset.hourly[0].pop+'%'})
    ...
    switch(true){
      ...
      case ('Thunderstorm'==this.state.dataset.current.weather[0].main):
        ...
        break;
      default:
        this.setState({weather0: this.state.dataset.current.weather[0].description})
        ...
        <div className={utilStyles.today}>
          ...
          <div className={utilStyles.weatherDetail}>
            ...
            <div className={utilStyles.temperature}>
              <span id="cmaxtem">{this.state.cmaxtem0}°</span>/<span id="cminem">{this.state.cmintem0}°</span>
            </div>
