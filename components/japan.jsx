...
const Japanmap=()=>{
    ...
    <>
        ...
        <div className={Map.japan_map}>
            <Image
              src="/public/japan.png"
              height={144}
              width={144}
            />
            <span className={Map.area_btn.area1} data-area="1">北海道・東北</span>
            <span className={Map.area_btn.area2} data-area="2">関東</span>
            <span className={Map.area_btn.area3} data-area="3">中部</span>
            <span className={Map.area_btn.area4} data-area="4">近畿</span>
            <span className={Map.area_btn.area5} data-area="5">中国・四国</span>
            <span className={Map.area_btn.area6} data-area="6">九州・沖縄</span>
      
      <div className={Map.area_overlay}></div>
      <div className={Map.pref_area}>
          <div className={Map.pref_list} data-list="1">
          ...
          <div className={Map.pref_list} data-list="2">
          ...
          <div className={Map.pref_list} data-list="3">
          ...
          <div className={Map.pref_list} data-list="4">
          ...
          <div className={Map.pref_list} data-list="5">
          ...
          <div className={Map.pref_list} data-list="6">
